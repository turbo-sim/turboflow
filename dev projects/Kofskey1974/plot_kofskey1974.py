...
filename = (
    "output\performance_analysis_2024-03-16_20-10-25.xlsx"  # performance map, 1963 REVS
)
...
if Case == "pressure_line":
    ...
    if save_figs:
        tf.plot_functions.savefig_in_formats(
            fig1, "figures/1974_mass_flow_rate", formats=[".eps"]
        )
        ...
        tf.plot_functions.savefig_in_formats(
            fig4, "figures/1974_absolute_flow_angle", formats=[".eps"]
        )
        tf.plot_functions.savefig_in_formats(
            fig5, "figures/1974_torque", formats=[".eps"]
        )
    ...
    if save_figs:
        tf.plot_functions.savefig_in_formats(
            fig1, "figures/error_1974_mass_flow_rate_error", formats=[".eps"]
        )
        # ml.plot_functions.savefig_in_formats(fig2, "figures/error_1974_efficiency_error", formats = [".eps"])
        tf.plot_functions.savefig_in_formats(
            fig3, "figures/error_1974_torque_error", formats=[".eps"]
        )
        tf.plot_functions.savefig_in_formats(
            fig4, "figures/error_1974_absolute_flow_angle_error", formats=[".eps"]
        )
