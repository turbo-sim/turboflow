...
fig, ax = ml.plot_functions.plot_subsets(performance_data, 'pr_ts', 'm', subset, xlabel = "Pressure ratio", ylabel = "Mass flow rate [kg/s]")

# Plot total-to-static efficiency at different angular speed
fig, ax = ml.plot_functions.plot_subsets(performance_data, 'pr_ts', 'eta_ts', subset, xlabel = "Pressure ratio", ylabel = "Total-to-static efficiency [%]")
...
fig, ax = ml.plot_functions.plot_lines_on_subset(performance_data, 'pr_ts', column_names, subset, xlabel = "Pressure ratio", ylabel = "Mach")
