...
def compute_impeller_losses(input_parameters):
    ...
    p_in = input_parameters["inlet_plane"]["p"]
    Ma_rel_in = input_parameters["inlet_plane"]["Ma_rel"]
    ...
    p_th = input_parameters["throat_plane"]["p"]
    ...
    # Clearance loss (Rogers)
    Y_cl = 0.1*t_cl/b_out*u_out**2
    ...
    # Shock losses (Whitfield and Baines)
    Y_sh = w_in**2/2*(1-(w_th/w_in)**2-2/((gamma_in-1)*Ma_rel_in**2)*((p_th/p_in)**(gamma_in/(gamma_in-1))-1))
