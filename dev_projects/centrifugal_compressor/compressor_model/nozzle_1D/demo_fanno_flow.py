...
# Validate model for Fanno flow of a perfect gas
fluid_name = "nitrogen"
...
Re_in = v_in * state_in.rho * diameter_in / state_in.mu
f_in = functions.get_friction_factor_haaland(Re_in, roughness, diameter_in)
length_choke = functions.get_choke_length_fanno(
    mach_in, state_in.gamma, f_in, diameter_in
)
length = length_choke
