...
# if save_fig:
tf.savefig_in_formats(fig1, f'{figures_dir}/1stage_convergence_rate_objective', formats=[".png", ".eps"])
tf.savefig_in_formats(fig2, f'{figures_dir}/1stage_convergence_rate_constrain_violation', formats=[".png", ".eps"])
