...
def compute_optimal_turbine(
    ...
    dfs = {
        ...
        "planes": problem.results["planes"],
        "cascades": problem.results["cascades"],
...
class CascadesOptimizationProblem(psv.OptimizationProblem):
    ...
    def index_variables(self, variables):
        ...
        for key in variables.keys():
            if isinstance(variables[key]["value"], (list, jnp.ndarray)):
    ...
    def get_given_bounds(self, design_variables):
        ...
        for key in design_variables.keys():
            ...
            elif isinstance(design_variables[key]["value"], jnp.ndarray):
    ...
    def get_nested_value(self, d, path):
        ...
        keys = path.split('.')
        print("hello", keys)
        print(d[keys[0]][keys[1]], type(d[keys[0]][keys[1]]))
