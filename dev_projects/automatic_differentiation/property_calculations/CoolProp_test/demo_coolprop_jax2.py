...
def get_props_custom_jvp(input_state, prop1, prop2):
...
def get_props_custom_jvp_jvp(input_state, primals, tangents):
...
grad_func = jax.jacfwd(get_props_custom_jvp, argnums=(1, 2))
gradients = grad_func(input_state, prop1, prop2)
print(gradients)
